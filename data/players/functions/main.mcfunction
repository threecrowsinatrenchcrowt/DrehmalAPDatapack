...
execute if score #1S timer matches 8 if score #region_locks rando_pools matches 1 if dimension minecraft:overworld run function rando:area_locks/overworld_region_check
execute if score #1S timer matches 8 if score #region_locks rando_pools matches 1 if dimension minecraft:lodahr unless score lo_dahr towers matches 1 run function rando:area_locks/locked_area_status
execute if score #1S timer matches 8 if score #region_locks rando_pools matches 1 if dimension minecraft:lodahr unless score lo_dahr towers matches 1 run title @s title {"text":"Lo'Dahr Locked","color":"red"}
execute if score #1S timer matches 8 if score #region_locks rando_pools matches 1 if dimension minecraft:space unless score aphelion towers matches 1 run function rando:area_locks/locked_area_status
execute if score #1S timer matches 8 if score #region_locks rando_pools matches 1 if dimension minecraft:space unless score aphelion towers matches 1 run title @s title {"text":"Aphelion Locked","color":"red"}
#--------#
#TRIGGERS#
#--------#
...
# Modified for randomizer menu
execute if score @s randoSettings matches -2147483648.. unless score @s randoSettings matches 0 run function rando:triggers/settings_root
