...
execute if score #legendaries rando_pools matches 0 as @s[tag=base] run data modify entity @e[tag=tempd,limit=1,sort=nearest] Item set from storage drehmal:core voidtear_base
execute if score #legendaries rando_pools matches 1 as @s[tag=base] run data modify entity @e[tag=tempd,limit=1,sort=nearest] Item set from storage drehmal:core voidtear_randomized
