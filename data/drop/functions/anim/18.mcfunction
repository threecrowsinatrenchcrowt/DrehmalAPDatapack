...
execute in minecraft:overworld unless score #terminus_towers rando_pools matches 1 run clone 26472 122 -158 26461 130 -148 26461 134 -158
execute in minecraft:overworld unless score #terminus_towers rando_pools matches 1 run fill 26470 138 -152 26470 140 -154 air
