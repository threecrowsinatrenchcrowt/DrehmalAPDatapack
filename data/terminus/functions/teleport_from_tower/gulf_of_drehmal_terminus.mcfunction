...
execute if score #terminus_towers rando_pools matches 0 if score gulf_of_drehmal towers matches 0 run function terminus:unlock_tower/gulf_of_drehmal_unlock
execute if score #terminus_towers rando_pools matches 1 run advancement grant @s only rando:locations/terminus_towers/gulf_of_drehmal_tower
