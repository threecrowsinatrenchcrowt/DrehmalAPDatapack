...
execute if score #terminus_towers rando_pools matches 0 if score spearhead_forest towers matches 0 run function terminus:unlock_tower/spearhead_forest_unlock
execute if score #terminus_towers rando_pools matches 1 run advancement grant @s only rando:locations/terminus_towers/spearhead_forest_tower
