...
execute if score #terminus_towers rando_pools matches 0 if score lorahn_kahl towers matches 0 run function terminus:unlock_tower/lorahn_kahl_unlock
execute if score #terminus_towers rando_pools matches 1 run advancement grant @s only rando:locations/terminus_towers/lorahn_kahl_tower
