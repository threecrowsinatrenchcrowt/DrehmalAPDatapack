...
execute if score #terminus_towers rando_pools matches 0 if score black_jungle towers matches 0 run function terminus:unlock_tower/black_jungle_unlock
execute if score #terminus_towers rando_pools matches 1 run advancement grant @s only rando:locations/terminus_towers/black_jungle_tower
