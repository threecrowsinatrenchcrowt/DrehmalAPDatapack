...
execute if score #terminus_towers rando_pools matches 0 if score ebony_veldt towers matches 0 run function terminus:unlock_tower/ebony_veldt_unlock
execute if score #terminus_towers rando_pools matches 1 run advancement grant @s only rando:locations/terminus_towers/ebony_veldt_tower
