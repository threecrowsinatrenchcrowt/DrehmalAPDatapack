...
execute if score #terminus_towers rando_pools matches 0 if score dawn_island towers matches 0 run function terminus:unlock_tower/dawn_island_unlock
execute if score #terminus_towers rando_pools matches 1 run advancement grant @s only rando:locations/terminus_towers/dawn_island_tower
