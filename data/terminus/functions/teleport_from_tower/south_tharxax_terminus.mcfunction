...
execute if score #terminus_towers rando_pools matches 0 if score south_tharxax towers matches 0 run function terminus:unlock_tower/south_tharxax_unlock
execute if score #terminus_towers rando_pools matches 1 run advancement grant @s only rando:locations/terminus_towers/south_tharxax_tower
