...
execute if score #terminus_towers rando_pools matches 0 if score veruhkt_plateau towers matches 0 run function terminus:unlock_tower/veruhkt_plateau_unlock
execute if score #terminus_towers rando_pools matches 1 run advancement grant @s only rando:locations/terminus_towers/veruhkt_plateau_tower
