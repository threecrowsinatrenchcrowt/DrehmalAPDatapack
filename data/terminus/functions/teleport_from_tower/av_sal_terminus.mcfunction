...
execute if score #terminus_towers rando_pools matches 0 if score av_sal towers matches 0 run function terminus:unlock_tower/av_sal_unlock
execute if score #terminus_towers rando_pools matches 1 run advancement grant @s only rando:locations/terminus_towers/av_sal_tower
