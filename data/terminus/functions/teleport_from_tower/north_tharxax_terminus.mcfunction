...
execute if score #terminus_towers rando_pools matches 0 if score north_tharxax towers matches 0 run function terminus:unlock_tower/north_tharxax_unlock
execute if score #terminus_towers rando_pools matches 1 run advancement grant @s only rando:locations/terminus_towers/north_tharxax_tower
