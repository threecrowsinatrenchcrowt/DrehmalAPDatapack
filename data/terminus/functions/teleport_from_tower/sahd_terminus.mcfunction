...
execute if score #terminus_towers rando_pools matches 0 if score sahd towers matches 0 run function terminus:unlock_tower/sahd_unlock
execute if score #terminus_towers rando_pools matches 1 run advancement grant @s only rando:locations/terminus_towers/sahd_tower
