...
execute if score #terminus_towers rando_pools matches 0 if score maels_desolation towers matches 0 run function terminus:unlock_tower/maels_desolation_unlock
execute if score #terminus_towers rando_pools matches 1 run advancement grant @s only rando:locations/terminus_towers/maels_desolation_tower
