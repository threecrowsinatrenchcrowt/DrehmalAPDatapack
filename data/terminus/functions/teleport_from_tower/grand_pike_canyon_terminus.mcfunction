...
execute if score #terminus_towers rando_pools matches 0 if score grand_pike_canyon towers matches 0 run function terminus:unlock_tower/grand_pike_canyon_unlock
execute if score #terminus_towers rando_pools matches 1 run advancement grant @s only rando:locations/terminus_towers/grand_pike_canyon_tower
