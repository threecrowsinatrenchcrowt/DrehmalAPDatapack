...
execute if score #terminus_towers rando_pools matches 0 if score anyr_nogur towers matches 0 run function terminus:unlock_tower/anyr_nogur_unlock
execute if score #terminus_towers rando_pools matches 1 run advancement grant @s only rando:locations/terminus_towers/anyr_nogur_tower
