...
execute if score #terminus_towers rando_pools matches 0 if score purity_peaks towers matches 0 run function terminus:unlock_tower/purity_peaks_unlock
execute if score #terminus_towers rando_pools matches 1 run advancement grant @s only rando:locations/terminus_towers/purity_peaks_tower
