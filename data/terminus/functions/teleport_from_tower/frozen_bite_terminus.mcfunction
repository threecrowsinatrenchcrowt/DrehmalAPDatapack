...
execute if score #terminus_towers rando_pools matches 0 if score frozen_bite towers matches 0 run function terminus:unlock_tower/frozen_bite_unlock
execute if score #terminus_towers rando_pools matches 1 run advancement grant @s only rando:locations/terminus_towers/frozen_bite_tower
