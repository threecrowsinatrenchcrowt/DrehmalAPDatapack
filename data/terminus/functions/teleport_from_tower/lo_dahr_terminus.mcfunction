...
execute if score #terminus_towers rando_pools matches 0 if score lo_dahr towers matches 0 run function terminus:unlock_tower/lo_dahr_unlock
execute if score #terminus_towers rando_pools matches 1 run advancement grant @s only rando:locations/terminus_towers/lo_dahr_tower
