...
execute if score #terminus_towers rando_pools matches 0 if score nimahj_swamp towers matches 0 run function terminus:unlock_tower/nimahj_swamp_unlock
execute if score #terminus_towers rando_pools matches 1 run advancement grant @s only rando:locations/terminus_towers/nimahj_swamp_tower
