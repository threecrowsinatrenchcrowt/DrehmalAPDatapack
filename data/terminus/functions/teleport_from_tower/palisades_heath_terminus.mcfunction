...
execute if score #terminus_towers rando_pools matches 0 if score palisades_heath towers matches 0 run function terminus:unlock_tower/palisades_heath_unlock
execute if score #terminus_towers rando_pools matches 1 run advancement grant @s only rando:locations/terminus_towers/palisades_heath_tower
