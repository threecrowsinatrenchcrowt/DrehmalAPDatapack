...
execute if score #terminus_towers rando_pools matches 0 if score merijool towers matches 0 run function terminus:unlock_tower/merijool_unlock
execute if score #terminus_towers rando_pools matches 1 run advancement grant @s only rando:locations/terminus_towers/merijool_tower
