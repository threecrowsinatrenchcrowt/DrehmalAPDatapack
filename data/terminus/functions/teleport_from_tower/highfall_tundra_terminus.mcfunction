...
execute if score #terminus_towers rando_pools matches 0 if score highfall_tundra towers matches 0 run function terminus:unlock_tower/highfall_tundra_unlock
execute if score #terminus_towers rando_pools matches 1 run advancement grant @s only rando:locations/terminus_towers/highfall_tundra_tower
