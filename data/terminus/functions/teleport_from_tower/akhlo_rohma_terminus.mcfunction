...
execute if score #terminus_towers rando_pools matches 0 if score akhlo_rohma towers matches 0 run function terminus:unlock_tower/akhlo_rohma_unlock
execute if score #terminus_towers rando_pools matches 1 run advancement grant @s only rando:locations/terminus_towers/akhlo_rohma_tower
