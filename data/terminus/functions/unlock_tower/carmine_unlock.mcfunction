...
execute in overworld run setblock 26466 90 -86 end_rod
execute in overworld run setblock 26405 139 -100 minecraft:sea_lantern
execute in overworld run setblock 26407 142 -99 minecraft:sea_lantern
execute in overworld run setblock 26407 137 -95 minecraft:sea_lantern
execute in overworld run setblock 26409 139 -100 minecraft:sea_lantern
