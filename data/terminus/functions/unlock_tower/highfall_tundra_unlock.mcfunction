...
execute in overworld run fill 26544 140 -100 26542 138 -100 air
execute in overworld run setblock 26496 90 -112 end_rod
execute in overworld run setblock 26541 139 -100 minecraft:sea_lantern
execute in overworld run setblock 26543 142 -99 minecraft:sea_lantern
execute in overworld run setblock 26543 137 -95 minecraft:sea_lantern
execute in overworld run setblock 26545 139 -100 minecraft:sea_lantern
