...
execute in overworld run fill 26530 140 -110 26532 138 -110 air
execute in overworld run setblock 26491 90 -109 end_rod
execute in overworld run setblock 26529 139 -110 minecraft:sea_lantern
execute in overworld run setblock 26531 142 -111 minecraft:sea_lantern
execute in overworld run setblock 26531 137 -115 minecraft:sea_lantern
execute in overworld run setblock 26533 139 -110 minecraft:sea_lantern
