...
execute in overworld run fill 26480 138 -74 26480 140 -72 air
execute in overworld run setblock 26478 90 -103 end_rod
execute in overworld run setblock 26480 139 -75 minecraft:sea_lantern
execute in overworld run setblock 26481 142 -73 minecraft:sea_lantern
execute in overworld run setblock 26485 137 -73 minecraft:sea_lantern
execute in overworld run setblock 26480 139 -71 minecraft:sea_lantern
